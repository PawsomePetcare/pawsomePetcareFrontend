    ...
    return (
        <div className="card mb-3" style={{ maxWidth: '18rem' }}>
            ...
            <div className="card-body text-center">
                ...
                {cartList.indexOf(id) < 0 && checkoutList.indexOf(id) < 0 ? 
                    <button className="btn btn-primary" onClick={() => addToCart(id)}>Book Now</button> :
                    checkoutList.indexOf(id) >= 0 ? 
                    <button className="btn btn-primary" disabled>You have opted for service</button> : 
